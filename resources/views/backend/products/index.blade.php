            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <p class="float-right">Total Products : {{App\Models\Product::count()}}
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <br>
                            <a href="{{route('product.create')}}" class="btn btn-primary btn-sm float-left" data-toggle="tooltip" data-placement="bottom" title="Add Banner"><i class="fas fa-plus"></i> Add Product</a>
                        <br>
                        </div>
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    @foreach($products as $item)
                                        <tr>
                                            ...
                                            <th>
                                                <a href="{{route('product.edit', $item->id)}}" data-toggle="tooltip" title="Edit" class="float-left btn btn-sm btn-outline-warning" data-placement="bottom">
                                                    <i class=" fas fa-edit">
                                                    </i>
                                                </a>
