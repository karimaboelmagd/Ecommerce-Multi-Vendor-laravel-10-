                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="stock" type="number" class="form-control" placeholder="Stock" name="stock" value="{{$product->stock}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="price" type="number" step="any" class="form-control" placeholder="Price" name="price" value="{{$product->price}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="discount" type="number" min="0" max="100" step="any" class="form-control" placeholder="Discount" name="discount" value="{{$product->discount}}">
                                        </div>
                                    </div>
